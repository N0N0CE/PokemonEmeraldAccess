...
function Program.main()
	...
	--]]
	elseif LayoutSettings.menus.main.selecteditem == LayoutSettings.menus.main.WINDOWS then
		Drawing.drawWindows()
	elseif LayoutSettings.menus.main.selecteditem == LayoutSettings.menus.main.MISC then
		Drawing.drawMisc()
	elseif LayoutSettings.menus.main.selecteditem == LayoutSettings.menus.main.TILES then
		Drawing.drawTiles()
	elseif LayoutSettings.menus.main.selecteditem == LayoutSettings.menus.main.BG then
		Drawing.drawBg()
	end
	Drawing.drawButtons()
	Drawing.drawLayout()
